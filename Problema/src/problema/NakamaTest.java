...
public class NakamaTest {
	...
	public void testDecodificadorDeNakamas() {
		...
		String res = problema1.decodificadorDeNakamas("Estaba en Texas tranquila hasta que un extraño grito a mi exmarido, exijia que Felix tuviera sexo con el, mi exmarido lo boxeo y pedimos un taxi");
